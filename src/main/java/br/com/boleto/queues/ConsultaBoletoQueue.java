...
public class ConsultaBoletoQueue implements Runnable {
	private BoletoProcessorFactory boletoProcessorFactory;

	private BlockingQueue<Conta> queue;

	public ConsultaBoletoQueue(BlockingQueue<Conta> queue, BoletoProcessorFactory boletoProcessorFactory) {
		this.queue = queue;
