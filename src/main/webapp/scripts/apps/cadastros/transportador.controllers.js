...
function transportadorController($scope, $compile, DTOptionsBuilder, DTColumnBuilder,ModalService) {
    ...
    vm.dtColumns = [
        ...
        DTColumnBuilder.newColumn('IES').withTitle('Inscr Est Subst Trib'), 
        DTColumnBuilder.newColumn('IIE').withTitle('Indicador de IE'), 
        DTColumnBuilder.newColumn('IE').withTitle('Inscrição Estadual'), 
        DTColumnBuilder.newColumn('IM').withTitle('Inscrição Municipal'), 
        DTColumnBuilder.newColumn('IF').withTitle('Inscrição Suframa'),  
        ...
        DTColumnBuilder.newColumn('obs').withTitle('Data nascimento').notVisible(),
