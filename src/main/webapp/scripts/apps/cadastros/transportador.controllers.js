(function() {
angular.module('wdApp.apps.transportador', ['datatables','angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
.controller('TransportadorController', transportadorController);

function transportadorController($scope, $compile, DTOptionsBuilder, DTColumnBuilder,ModalService) {
    ...
    vm.dtOptions = DTOptionsBuilder.fromSource('clientes.json')
        .withDOM('frtip')
...
function comprasController($scope, $compile, DTOptionsBuilder, DTColumnBuilder,ModalService) {
    var vm = this;
    vm.selected = {};
    vm.selectAll = false;
    vm.toggleAll = toggleAll;
...
(function() {
angular.module('wdApp.apps.pagamentos', ['datatables','angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
.controller('PagamentosController', pagamentosController);

function pagamentosController($scope, $compile, DTOptionsBuilder, DTColumnBuilder,ModalService) {
    var vm = this;
    vm.selected = {};
    vm.selectAll = false;
    vm.toggleAll = toggleAll;
