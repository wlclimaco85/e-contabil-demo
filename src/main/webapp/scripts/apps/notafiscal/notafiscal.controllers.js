(function() {
angular.module('wdApp.apps.notaFiscal', ['datatables','angularModalService', 'datatables.buttons', 'datatables.light-columnfilter', 'datatables.bootstrap','datatables.columnfilter'])
    .controller('NotaFiscalController', notaFiscalController);

function notaFiscalController($scope, $compile, DTOptionsBuilder, DTColumnBuilder,ModalService) {
    ...
    vm.dtOptions = DTOptionsBuilder.fromSource('orcamento.json')
        ...
        .withButtons([
            ...
            {
                text: 'Novo Nota Fiscal',
                key: '1',
                action: function (e, dt, node, config) {
                    ModalService.showModal({
                        templateUrl: 'modalNfSaida.html',
      ...
      vm.dtColumns = [
        ...
        DTColumnBuilder.newColumn('data').withTitle('data').withOption('width', '50px'),
         DTColumnBuilder.newColumn(null).withTitle('qntProd').notSortable().withOption('width', '15px')
            .renderWith(function(data, type, full, meta) {
                return '<a> '+ data.qntProd +'</a>';
            }),
       // DTColumnBuilder.newColumn('qntProd').withTitle('qntProd'),
        DTColumnBuilder.newColumn('valorPedido').withTitle('Valor NF-e'),
        DTColumnBuilder.newColumn('valorItens').withTitle('valor Itens'),
    ...
    function actionsHtml(data, type, full, meta) {
        ...
        return ' <div class="dropdown">'+
          ...
          '<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">'+
            '<li><a href="javaScript:;">Detalhar</a></li>'+
            '<li><a href="javaScript:;">Validar</a></li>'+
            '<li><a href="javaScript:;">Assinar</a></li>'+
            '<li><a href="javaScript:;">Transmitir</a></li>'+
            '<li role="separator" class="divider"></li>'+
            '<li><a href="javaScript:;">Pré Visualizar DANFE</a></li>'+
            '<li><a href="javaScript:;">Imprimir DANFE</a></li>'+
            '<li><a href="javaScript:;">Consultar na SEFAZ</a></li>'+
            '<li><a href="javaScript:;">Duplicar</a></li>'+
            '<li role="separator" class="divider"></li>'+
            '<li><a href="javaScript:;">Exportar</a></li>'+
            '<li><a href="javaScript:;">Cancelar NF-e</a></li>'+
            '<li><a href="javaScript:;">Excluir</a></li>'+
            '<li><a href="javaScript:;">Enviar EPEC</a></li>'+
            '<li><a href="javaScript:;">Carta de Correção</a></li>'+
            '<li><a href="javaScript:;">Enviar Email</a></li>'+
          '</ul>'+
        '</div>'
/*
