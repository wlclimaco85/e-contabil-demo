(function() {
angular.module('wdApp.apps.ordemProducao', ['datatables','angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
.controller('OrdemProducaoController', ordemProducaoController);

function ordemProducaoController($scope, $compile, DTOptionsBuilder, DTColumnBuilder,ModalService) {
    var vm = this;
    vm.selected = {};
    vm.selectAll = false;
