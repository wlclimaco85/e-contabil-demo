...
function contaController($scope, $compile, DTOptionsBuilder, DTColumnBuilder,ModalService) {
    var vm = this;
    vm.selected = {};
    vm.selectAll = false;
    ...
    vm.dtColumns = [
        ...
        DTColumnBuilder.newColumn('banco').withTitle('Banco').notVisible(),
        DTColumnBuilder.newColumn('agencia').withTitle('Agencia').notVisible(),
        DTColumnBuilder.newColumn('numConta').withTitle('Numero Conta'),
        DTColumnBuilder.newColumn('gerente').withTitle('Nome Gerente'),
        DTColumnBuilder.newColumn('emailGerente').withTitle('Email Gerente'),
        DTColumnBuilder.newColumn('telGerente').withTitle('Telefone Gerente'),
        DTColumnBuilder.newColumn('saldoInicial').withTitle('Saldo Inicial'),
        DTColumnBuilder.newColumn('saldoAtual').withTitle('Saldo Atual'),
