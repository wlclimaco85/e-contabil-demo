...
.controller('FormaPagController', formaPagController);

function formaPagController($scope, $compile, DTOptionsBuilder, DTColumnBuilder,ModalService) {
    var vm = this;
    vm.selected = {};
    vm.selectAll = false;
    ...
    vm.dtColumns = [
        ...
        DTColumnBuilder.newColumn('parcela').withTitle('Parcelamento máx.'),    
        DTColumnBuilder.newColumn('parcelaSJuros').withTitle('Parcelas sem juros'),
        DTColumnBuilder.newColumn('juros').withTitle('Juros (%)'),
        DTColumnBuilder.newColumn('taxaFixa').withTitle('Taxa fixa ($)'),
        DTColumnBuilder.newColumn('desc').withTitle('Desconto a vista (%)').notVisible(),
        DTColumnBuilder.newColumn('tipoDoc').withTitle('Tipo de documento padrão'),
        DTColumnBuilder.newColumn('intervPadrao').withTitle('Intervalo padrão entre as parcelas'),
